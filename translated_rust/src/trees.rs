...
pub use crate::src::deflate::StaticTreeKind;
...
pub use crate::src::deflate::STATIC_BIT_LENGTH;
pub use crate::src::deflate::STATIC_DISTANCE;
pub use crate::src::deflate::STATIC_LITERAL_LENGTH;
...
fn static_tree(kind: StaticTreeKind) -> Option<&'static [crate::src::deflate::ct_data]> {
    match kind {
        STATIC_LITERAL_LENGTH => Some(&static_ltree),
        STATIC_DISTANCE => Some(&static_dtree),
        _ => None,
    }
}

fn extra_bits(kind: StaticTreeKind) -> &'static [crate::stdlib::intf] {
    match kind {
        STATIC_LITERAL_LENGTH => &extra_lbits,
        STATIC_DISTANCE => &extra_dbits,
        _ => &extra_blbits,
    }
}

fn extra_base(kind: StaticTreeKind) -> ::core::ffi::c_int {
    match kind {
        STATIC_LITERAL_LENGTH => crate::src::deflate::LITERALS + 1,
        _ => 0,
    }
}

fn descriptor_elems(kind: StaticTreeKind) -> ::core::ffi::c_int {
    match kind {
        STATIC_LITERAL_LENGTH => crate::src::deflate::L_CODES,
        STATIC_DISTANCE => crate::src::deflate::D_CODES,
        _ => crate::src::deflate::BL_CODES,
    }
}

fn descriptor_max_length(kind: StaticTreeKind) -> ::core::ffi::c_int {
    match kind {
        STATIC_LITERAL_LENGTH | STATIC_DISTANCE => crate::src::deflate::MAX_BITS,
        _ => MAX_BL_BITS,
    }
}
...
fn bi_flush(s: &mut crate::src::deflate::deflate_state, pending_buf: &mut [crate::stdlib::Byte]) {
...
fn bi_windup(s: &mut crate::src::deflate::deflate_state, pending_buf: &mut [crate::stdlib::Byte]) {
...
fn gen_codes(
    ...
    for entry in &mut tree[..=max_code] {
        let len: ::core::ffi::c_int = entry.dl.len as ::core::ffi::c_int;
        if len != 0 as ::core::ffi::c_int {
...
fn gen_bitlen(
    ...
    stat_desc: crate::src::deflate::StaticTreeKind,
    heap: &[::core::ffi::c_int],
    heap_max: ::core::ffi::c_int,
    bl_count: &mut [crate::zutil_h::ush],
    opt_len: &mut crate::zutil_h::ulg,
    static_len: &mut crate::zutil_h::ulg,
) {
    let stree = static_tree(stat_desc);
    let extra = extra_bits(stat_desc);
    let base = extra_base(stat_desc);
    let max_length = descriptor_max_length(stat_desc);
    ...
    tree[heap[heap_max as usize] as usize].dl.len = 0 as crate::zutil_h::ush;
    h = heap_max + 1 as ::core::ffi::c_int;
    while h < crate::src::deflate::HEAP_SIZE {
        n = heap[h as usize];
        bits = tree[tree[n as usize].dl.len as usize].dl.len as ::core::ffi::c_int
            + 1 as ::core::ffi::c_int;
        if bits > max_length {
            bits = max_length;
            overflow += 1;
        }
        tree[n as usize].dl.len = bits as crate::zutil_h::ush;
        if n <= max_code {
            ...
            *opt_len =
            ...
            if let Some(stree) = stree {
                *static_len = static_len.wrapping_add((f as crate::zutil_h::ulg).wrapping_mul(
                    (stree[n as usize].dl.len as ::core::ffi::c_int + xbits) as ::core::ffi::c_uint
    ...
    while bits != 0 as ::core::ffi::c_int {
        ...
        while n != 0 as ::core::ffi::c_int {
            ...
            if tree[m as usize].dl.len as ::core::ffi::c_uint != bits as ::core::ffi::c_uint {
                *opt_len = opt_len.wrapping_add(
                    (bits as crate::zutil_h::ulg)
                        .wrapping_sub(tree[m as usize].dl.len as crate::zutil_h::ulg)
                        .wrapping_mul(tree[m as usize].fc.freq as crate::zutil_h::ulg),
                );
                tree[m as usize].dl.len = bits as crate::zutil_h::ush;
            }
            n -= 1;
        }
        bits -= 1;
...
fn build_tree(
    ...
    depth: &mut [crate::zutil_h::uch],
    bl_count: &mut [crate::zutil_h::ush],
    opt_len: &mut crate::zutil_h::ulg,
    static_len: &mut crate::zutil_h::ulg,
) {
    let stree = static_tree(stat_desc);
    let elems = descriptor_elems(stat_desc);
    let mut n: ::core::ffi::c_int = 0;
    let mut m: ::core::ffi::c_int = 0;
    ...
    *heap_max = crate::src::deflate::HEAP_SIZE;
    ...
    while n < elems {
        if tree[n as usize].fc.freq as ::core::ffi::c_int != 0 as ::core::ffi::c_int {
            ...
            *heap_len += 1;
            ...
            tree[n as usize].dl.len = 0 as crate::zutil_h::ush;
        }
        n += 1;
    }
    while *heap_len < 2 as ::core::ffi::c_int {
        ...
        *opt_len = opt_len.wrapping_sub(1);
        if let Some(stree) = stree {
            *static_len =
                static_len.wrapping_sub(stree[node as usize].dl.len as crate::zutil_h::ulg);
        }
    }
    *max_code_out = max_code;
    ...
    loop {
        ...
        let heap_last = *heap_len;
        *heap_len -= 1;
        heap[SMALLEST as usize] = heap[heap_last as usize];
        ...
        *heap_max -= 1;
        ...
        tree[m as usize].dl.len = node as crate::zutil_h::ush;
        tree[n as usize].dl.len = tree[m as usize].dl.len;
        let next_node = node;
        node = node + 1;
        heap[SMALLEST as usize] = next_node;
        pqdownheap(heap, *heap_len, depth, tree, SMALLEST);
    ...
    *heap_max -= 1;
    ...
    gen_codes(&mut tree[..elems as usize], max_code as usize, bl_count);
}

fn build_l_tree(state: &mut crate::src::deflate::deflate_state) {
...
fn build_d_tree(state: &mut crate::src::deflate::deflate_state) {
    let crate::src::deflate::internal_state {
        dyn_dtree,
        d_desc,
        heap,
...
fn build_bl_huffman_tree(state: &mut crate::src::deflate::deflate_state) {
    let crate::src::deflate::internal_state {
        bl_tree,
        bl_desc,
        heap,
...
fn scan_tree(
    ...
    let mut nextlen: ::core::ffi::c_int = tree[0].dl.len as ::core::ffi::c_int;
    ...
    tree[(max_code + 1 as ::core::ffi::c_int) as usize].dl.len =
        0xffff as ::core::ffi::c_int as crate::zutil_h::ush;
    n = 0 as ::core::ffi::c_int;
    while n <= max_code {
        curlen = nextlen;
        nextlen = tree[(n + 1 as ::core::ffi::c_int) as usize].dl.len as ::core::ffi::c_int;
        count += 1;
...
fn send_code(
    ...
    let (code, len) = {
        ...
        (
            ...
            entry.dl.len as ::core::ffi::c_int,
        )
    };
    send_bits(s, pending_buf, code, len);
}
...
fn send_tree(
    ...
    while n <= max_code {
        ...
        if !(count < max_count && curlen == nextlen) {
            if count < min_count {
                loop {
                    send_code(s, pending_buf, curlen as usize);
                    count -= 1;
                ...
                send_code(s, pending_buf, REP_3_6 as usize);
                send_bits(
                    s,
                    pending_buf,
                    count - 3 as ::core::ffi::c_int,
                    2 as ::core::ffi::c_int,
                );
            } else if count <= 10 as ::core::ffi::c_int {
                send_code(s, pending_buf, REPZ_3_10 as usize);
                send_bits(
                    s,
                    pending_buf,
                    count - 3 as ::core::ffi::c_int,
                ...
                send_code(s, pending_buf, REPZ_11_138 as usize);
                send_bits(
                    s,
                    pending_buf,
                    count - 11 as ::core::ffi::c_int,
                    7 as ::core::ffi::c_int,
                );
            }
            count = 0 as ::core::ffi::c_int;
...
fn build_bl_tree(state: &mut crate::src::deflate::deflate_state) -> ::core::ffi::c_int {
    ...
    {
        let max_code = state.l_desc.max_code;
        scan_tree(&mut state.bl_tree, &mut state.dyn_ltree, max_code);
        let max_code = state.d_desc.max_code;
        scan_tree(&mut state.bl_tree, &mut state.dyn_dtree, max_code);
    }
    build_bl_huffman_tree(state);
    max_blindex = crate::src::deflate::BL_CODES - 1 as ::core::ffi::c_int;
    while max_blindex >= 3 as ::core::ffi::c_int {
        if state.bl_tree[bl_order[max_blindex as usize] as usize]
            .dl
...
fn send_all_trees(
    ...
    send_bits(state, pending_buf, lcodes - 257, 5);
    send_bits(state, pending_buf, dcodes - 1, 5);
    send_bits(state, pending_buf, blcodes - 4, 4);
    for rank in 0..blcodes as usize {
        send_bits(
            state,
            pending_buf,
            state.bl_tree[bl_order[rank] as usize].dl.len as ::core::ffi::c_int,
            3,
        );
    }
...
pub fn tr_stored_block(
    ...
    send_bits(state, pending_buf, last, 3);
    bi_windup(state, pending_buf);

    let len = stored_len as crate::zutil_h::ush;
    for byte in [
        len as crate::stdlib::Byte,
        (len >> 8) as crate::stdlib::Byte,
        (!len) as crate::stdlib::Byte,
        (!len >> 8) as crate::stdlib::Byte,
    ] {
        let pending = state.pending as usize;
        state.pending = state.pending.wrapping_add(1);
        pending_buf[pending] = byte;
    }
...
pub fn _tr_align(
    ...
    send_bits(state, pending_buf, 1 << 1, 3);
    let end = &static_ltree[256];
    send_bits(
        state,
        pending_buf,
        end.fc.freq as ::core::ffi::c_int,
        end.dl.len as ::core::ffi::c_int,
    );
    bi_flush(state, pending_buf);
}
...
fn compress_block(
    ...
    let mut symbol = 0;
    while symbol < symbol_len {
        let mut dist = u32::from(pending_buf[symbols_start + symbol])
            | (u32::from(pending_buf[symbols_start + symbol + 1]) << 8);
        let mut lc = pending_buf[symbols_start + symbol + 2] as ::core::ffi::c_int;
        symbol += 3;
        if dist == 0 {
            send_tree_code(s, pending_buf, ltree, lc as usize);
            continue;
        }

        let mut code = _length_code[lc as usize] as usize;
        send_tree_code(s, pending_buf, ltree, code + 257);
        ...
        send_tree_code(s, pending_buf, dtree, code);
        let extra = extra_dbits[code];
        if extra != 0 {
            dist = dist.wrapping_sub(base_dist[code] as u32);
            send_bits(s, pending_buf, dist as ::core::ffi::c_int, extra);
        }
    }
    send_tree_code(s, pending_buf, ltree, 256);
}
...
pub fn tr_flush_block(
    ...
    if stored_len.wrapping_add(4 as crate::zutil_h::ulg) <= opt_lenb && source.is_some() {
        tr_stored_block(state, pending_buf, source, stored_len, last);
    } else if static_lenb == opt_lenb {
        send_bits(state, pending_buf, (1 << 1) + last, 3);
        ...
        send_bits(state, pending_buf, (2 << 1) + last, 3);
...
pub(crate) fn tr_tally(
    ...
    let symbol = state.sym_next as usize;
    pending_buf[symbol_start + symbol..symbol_start + symbol + 3].copy_from_slice(&[
        dist as crate::zutil_h::uch,
        (dist >> 8 as ::core::ffi::c_int) as crate::zutil_h::uch,
        lc as crate::zutil_h::uch,
    ]);
    state.sym_next = state.sym_next.wrapping_add(3);
    if dist == 0 as ::core::ffi::c_uint {
        ...
        state.dyn_ltree[length_code].fc.freq = state.dyn_ltree[length_code].fc.freq.wrapping_add(1);
        ...
        state.dyn_dtree[distance_code].fc.freq =
            state.dyn_dtree[distance_code].fc.freq.wrapping_add(1);
    }
