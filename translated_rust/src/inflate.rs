...
pub unsafe extern "C" fn inflatePrime(
    ...
    return inflate_prime(&mut *state, bits, value);
}
...
pub unsafe extern "C" fn inflate(
    ...
    let mut output_start: *const ::core::ffi::c_uchar =
                                    ...
                                    if (*state).flags & 0x400 as ::core::ffi::c_int != 0 {
                                        ...
                                        if copy != 0 {
                                            if !(*state).head.is_null() {
                                                ...
                                                let extra_offset = (head.extra_len as ::core::ffi::c_uint)
...
pub unsafe extern "C" fn inflateCodesUsed(
    ...
    state = (*strm).state as *mut crate::src::inflate::inflate_state;
    return inflate_codes_used(&*state);
}
