...
enum InflateHeaderUpdate<'a> {
    Done(::core::ffi::c_int),
    Text(::core::ffi::c_int),
    Time(crate::stdlib::uLong),
    XflagsAndOs(::core::ffi::c_int, ::core::ffi::c_int),
    ExtraLen(crate::stdlib::uInt),
    ClearExtra,
    CopyExtra {
...
pub unsafe extern "C" fn inflateResetKeep_ffi(
    ...
    inflate_reset_keep_stream(strm)
}
pub fn inflateReset(
    strm: &mut crate::zlib_h::z_stream,
    state: &mut crate::src::inflate::inflate_state,
...
/// Keep mutable opaque-state access behind the typed stream bridge. The FFI
/// entry point only validates its stream pointer before dispatching here.
fn inflate_reset_keep_stream(strm: &mut crate::zlib_h::z_stream) -> ::core::ffi::c_int {
    if !inflate_stream_has_allocators(strm) {
        return crate::zlib_h::Z_STREAM_ERROR;
    }
    with_inflate_stream_state(strm, inflateResetKeep)
        .unwrap_or(crate::zlib_h::Z_STREAM_ERROR)
}
...
pub unsafe extern "C" fn inflatePrime_ffi(
    ...
    inflate_prime_for_stream(strm, bits, value)
}
fn update_window(
    state: &mut crate::src::inflate::inflate_state,
    window: &mut [u8],
...
pub fn inflate(
    ...
    with_inflate_stream_state(strm, |strm, state_ref| {
        if !inflate_state_valid(strm, state_ref) {
            return crate::zlib_h::Z_STREAM_ERROR;
        }
        // `inflateGetHeader` installs a typed header handle before decoding.
        // The decoder selects safe updates and leaves ABI writes to the
        // narrow state-specific boundary below.
        let state = state_ref;
        ...
        '_inf_leave: loop {
            'c_2425: {
                                    ...
                                    'c_2410: {
                                                ...
                                                'c_2397: {
                                                        ...
                                                        'c_2340: {
                                                            'c_2443: {
                                                                'c_2339: {
                                                                        ...
                                                                        'c_2356: {
                                                                            's_1689: {
                                                                                            ...
                                                                                            's_1582: {
                                                                                                    ...
                                                                                                    if state.wrap == 0 as ::core::ffi::c_int {
                                                                                                            ...
                                                                                                            && hold == 0x8b1f as ::core::ffi::c_ulong
                                                                                                        {
                                                                                                            ...
                                                                                                            if state.head.is_some() {
                                                                                                                apply_inflate_header_update(state, InflateHeaderUpdate::Done(-1));
                                                                                                            }
                                                                                                ...
                                                                                                16181 => {
                                                                                                    ...
                                                                                                    } else if state.flags & 0xe000 as ::core::ffi::c_int != 0
                                                                                                    {
                                                                                                        ...
                                                                                                        if state.head.is_some() {
                                                                                                            apply_inflate_header_update(state, InflateHeaderUpdate::Text((hold >> 8 as ::core::ffi::c_int
                                                                                    ...
                                                                                    while bits < 32 as ::core::ffi::c_int as ::core::ffi::c_uint
                                                                                {
                                                                                    ...
                                                                                    if state.head.is_some() {
                                                                                        apply_inflate_header_update(state, InflateHeaderUpdate::Time(hold
                                                                                            as crate::stdlib::uLong));
                                                                                    }
                                                                                    if state.flags & 0x200 as ::core::ffi::c_int != 0
                                                                                    && state.wrap & 4 as ::core::ffi::c_int != 0
                                                                    ...
                                                                    if state.head.is_some() {
                                                                        apply_inflate_header_update(state, InflateHeaderUpdate::XflagsAndOs((hold
                                                                        & 0xff
                                                                            as ::core::ffi::c_ulong)
                                                                        as ::core::ffi::c_int, (hold
                                                                        >> 8 as ::core::ffi::c_int)
                                                                        as ::core::ffi::c_int));
                                                                    }
                                                                    if state.flags
                                                        ...
                                                        != 0
                                                    {
                                                        ...
                                                        state.length =
                                                            hold as ::core::ffi::c_uint;
                                                        if state.head.is_some() {
                                                            apply_inflate_header_update(state, InflateHeaderUpdate::ExtraLen(hold
                                                                as ::core::ffi::c_uint
                                                        ...
                                                        hold = 0 as ::core::ffi::c_ulong;
                                                        bits = 0 as ::core::ffi::c_uint;
                                                    } else if state.head.is_some() {
                                                        apply_inflate_header_update(state, InflateHeaderUpdate::ClearExtra);
                                                    }
                                        ...
                                        if state.flags & 0x400 as ::core::ffi::c_int != 0 {
                                            ...
                                            if copy != 0 {
                                                ...
                                                if state.head.is_some() {
                                                    apply_inflate_header_update(state, InflateHeaderUpdate::CopyExtra {
                                ...
                                if state.flags & 0x800 as ::core::ffi::c_int != 0 {
                                    ...
                                    loop {
                                        ...
                                        len = name_input[c2rust_fresh5 as usize]
                                            as ::core::ffi::c_uint;
                                        if state.head.is_some() {
                                            if apply_inflate_header_update(state, InflateHeaderUpdate::CopyName {
                                                index: state.length,
                                                byte: len as crate::stdlib::Bytef,
                                            }) {
                                    ...
                                    apply_inflate_header_update(state, InflateHeaderUpdate::ClearName);
                                }
                                state.length = 0 as ::core::ffi::c_uint;
                        ...
                        if state.flags & 0x1000 as ::core::ffi::c_int != 0 {
                            ...
                            loop {
                                ...
                                len = comment_input[c2rust_fresh7 as usize]
                                    as ::core::ffi::c_uint;
                                if state.head.is_some() {
                                    if apply_inflate_header_update(state, InflateHeaderUpdate::CopyComment {
                                        index: state.length,
                                        byte: len as crate::stdlib::Bytef,
                                    }) {
                                        state.length = state.length.wrapping_add(1);
                            ...
                            apply_inflate_header_update(state, InflateHeaderUpdate::ClearComment);
                        }
                ...
                if state.head.is_some() {
                    apply_inflate_header_update(state, InflateHeaderUpdate::HcrcAndDone(
...
fn inflate_set_dictionary_for_stream(
    strm: &mut crate::zlib_h::z_stream,
    dictionary: &[crate::stdlib::Bytef],
) -> ::core::ffi::c_int {
    if !inflate_stream_has_allocators(strm) {
...
pub unsafe extern "C" fn inflateSync_ffi(mut strm: crate::zlib_h::z_streamp) -> ::core::ffi::c_int {
    ...
    inflate_sync_for_stream(strm, input)
}
...
fn inflate_undermine_for_stream(
    strm: &mut crate::zlib_h::z_stream,
    subvert: ::core::ffi::c_int,
) -> ::core::ffi::c_int {
    if !inflate_stream_has_allocators(strm) {
    ...
    .unwrap_or_else(|| inflate_undermine(None, subvert))
}
...
pub unsafe extern "C" fn inflateUndermine_ffi(
    ...
    inflate_undermine_for_stream(strm, subvert)
}
fn inflate_validate(
    state: Option<&mut crate::src::inflate::inflate_state>,
...
fn inflate_validate_for_stream(
    strm: &mut crate::zlib_h::z_stream,
    check: ::core::ffi::c_int,
) -> ::core::ffi::c_int {
    if !inflate_stream_has_allocators(strm) {
    ...
    .unwrap_or_else(|| inflate_validate(None, check))
}
...
pub unsafe extern "C" fn inflateValidate_ffi(
    ...
    inflate_validate_for_stream(strm, check)
}
