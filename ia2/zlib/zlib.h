...
typedef struct IA2_fnptr__ZTSFPvS_jjE alloc_func;
typedef struct IA2_fnptr__ZTSFvPvS_E free_func;
...
typedef struct IA2_fnptr__ZTSFjPvPPhE in_func;
typedef struct IA2_fnptr__ZTSFiPvPhjE out_func;
